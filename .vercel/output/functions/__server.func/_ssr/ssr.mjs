...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CDGqY8aR.mjs");
...
var manifest = {
	"2ead3a79afc1c3219bd00665283ba2f3705802a525e87034d7e27489ad43c9a6": {
		functionName: "diagnoseMistake_createServerFn_handler",
		importer: () => import("./study-ai-DNvCsUkP.mjs")
	},
	"49eba8f2dc160a479290eb1ce8ad817e2da795de0df9a2cbe1d2afc40ecf9452": {
		functionName: "generateMoreQuestions_createServerFn_handler",
		importer: () => import("./study-ai-DNvCsUkP.mjs")
	},
	"b2d600e7bcdc4a9edc5d6ce9f25be10c67707d59b87fb616b72dfc560a7a0297": {
		functionName: "evaluateTeachback_createServerFn_handler",
		importer: () => import("./study-ai-DNvCsUkP.mjs")
	},
	"c2bc800b0b448b7278600d25f50d142a04002b792847e4402fc241fc55621bfb": {
		functionName: "generateStudyPack_createServerFn_handler",
		importer: () => import("./study-ai-DNvCsUkP.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BxA6ilpM.mjs").then((n) => n.t),
