...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BxA6ilpM.js
var router_BxA6ilpM_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-BiKNAWwB.css";
var APP_NAME = "Studania";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Learn, revise, and practise any concept — with real diagnosis of what you misunderstand."
			},
			{
				name: "theme-color",
				content: "#243D56"
...
var $$splitComponentImporter = () => import("./routes-CVZvbEXJ.mjs");
...
//#endregion
export { getRouter, router_BxA6ilpM_exports as t };
